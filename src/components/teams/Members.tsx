...
const Members: React.FC<MemberProps> = ({ member }) => {
	...
	return (
		<li
			className={` flex-row border dark:border-darkBorder space-x-1  items-center flex overflow-x-hidden rounded-md h-16 p-0.5 dark:text-gray-400 hover:border-gray-400 hover:cursor-pointer`}
		...
		>
			...
			<article className="sm:flex flex-col hidden  truncate">
				<p className="dark:text-primaryGreen uppercase">{member.displayName}</p>
				{member.lastMessage && (
