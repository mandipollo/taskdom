...
const TaskDashboard: React.FC<taskBoardProps> = ({ taskList }) => {
	return (
		<section className=" max-h-full h-full pt-10 w-full ">
			<div className="flex justify-center items-center  py-2 px-4 border w-full dark:border-darkBorder ">
				Tasks
			</div>
							...
							<p
								className={`${
									task.status === "todo"
										? "border-orange-400"
										: "border-blue-400"
								}  flex p-2 w-full border bg-darkSecondary overflow-hidden overflow-x-auto text-ellipsis whitespace-nowrap`}
							>
								{task.title}
							</p>
						</li>
